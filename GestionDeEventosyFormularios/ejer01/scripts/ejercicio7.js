...
let parrafo1 = seccionTercera.getElementsByTagName('p')[0];
let primerParrafoDoc = document.getElementsByTagName('p')[0];

parrafo1.addEventListener('click', insertarEncabezadoH2);
primerParrafoDoc.addEventListener('dblclick', cambiarEstilos);
